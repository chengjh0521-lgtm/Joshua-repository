...
CONFIG = {
    ...
    "video_service_type": _runtime.get("video_service_type", "monitor_notify"),
    "video_notify_mode": _runtime.get("video_notify_mode", "none"),
    "video_publish_mode": _runtime.get("video_publish_mode", "none"),
